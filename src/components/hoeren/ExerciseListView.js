...
const getProgressColor = (percentage) => {
  if (percentage === 0) return '#E5E5EA'; // Gris clair
  ...
  return (
    <>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Hören - {selectedLevel}</Text>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.ubungenSection}>
          {ubungen.length === 0 ? (
            <View style={styles.emptyState}>
              <Ionicons name="headset-outline" size={48} color={colors.gray} />
              <Text style={styles.emptyStateText}>
                Keine Hörübungen für {selectedLevel} verfügbar
              </Text>
            </View>
          ) : (
            ubungen.map((ubung) => (
              ...
              >
                ...
                <View style={styles.ubungHeader}>
                  <View style={styles.ubungIconContainer}>
                    <Image source={require('../../../assets/images/hoerenImg.png')} style={styles.customIcon} />
                  </View>
        ...
        <View style={styles.tipsSection}>
          <Text style={styles.tipsTitle}>Tipps für besseres Hören</Text>
          <View style={styles.tipItem}>
            <Ionicons name="checkmark-circle" size={16} color={colors.success} />
            <Text style={styles.tipText}>Hören Sie zuerst ohne Fragen anzusehen</Text>
          </View>
          <View style={styles.tipItem}>
            <Ionicons name="checkmark-circle" size={16} color={colors.success} />
          ...
          <View style={styles.tipItem}>
            <Ionicons name="checkmark-circle" size={16} color={colors.success} />
            <Text style={styles.tipText}>Nutzen Sie den Kontext für das Verstehen</Text>
          </View>
        </View>
      </ScrollView>
    </>
