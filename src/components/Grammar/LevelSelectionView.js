...
const LevelSelectionView = ({ levels, onBack, onSelectLevel, getUbungenForLevel, userNativeLanguage = "AR" }) => {
  ...
  const interfaceTranslations = {
    newStoriesWaiting: {
      "DE": "Neue Regeln entdecken!",
      "FR": "De nouvelles règles à découvrir !",
      "EN": "New rules to discover!",
      "ES": "¡Nuevas reglas por descubrir!",
      "PT": "Novas regras para descobrir!",
      "PL": "Nowe zasady do odkrycia!",
      "RU": "Новые правила для изучения!",
      "TR": "Keşfedilecek yeni kurallar!",
      "IT": "Nuove regole da scoprire!",
      "UK": "Нові правила для вивчення!",
      "VI": "Những quy tắc mới cần khám phá!",
      "TL": "Mga bagong tuntunin na dapat tuklasin!",
      "ZH": "新规则等你发现！",
      "ID": "Aturan baru untuk ditemukan!",
      "TH": "กฎใหม่รอการค้นพบ!",
      "MS": "Peraturan baru untuk ditemui!",
      "AR": "قواعد جديدة للاكتشاف!"
    },
    reading: {
      "DE": "Grammatik",
      "FR": "Grammaire", 
