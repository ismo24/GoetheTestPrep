        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryStats}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValue}>{exerciseResults.totalQuestions}</Text>
            </View>
          </View>
        </View>
        ...
        {exerciseResults.percentage < 70 && (
          <View style={styles.improvementCard}>
            <View style={styles.improvementHeader}>
              ...
              <Text style={styles.improvementTitle}>Verbesserungsvorschläge</Text>
            </View>
            <Text style={styles.improvementText}>
              • Lesen Sie den Text noch einmal aufmerksam durch{'\n'}
