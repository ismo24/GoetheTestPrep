...
import ExerciseListView from '../components/lesen/ExerciseListView';
import ExerciseView from '../components/lesen/ExerciseView';
import ResultsView from '../components/lesen/ResultsView';
...
const LesenScreen = ({ navigation }) => {
  ...
  const levels = [
    {
      id: 'A1',
      title: 'Anfänger',
      subtitle: 'Grundlegendes Leseverstehen',
    ...
    },
    {
      id: 'A2',
      title: 'Grundlegend',
      subtitle: 'Einfache Texte verstehen',
    ...
    },
    {
      id: 'B1',
      title: 'Mittelstufe',
      subtitle: 'Alltägliche Texte verstehen',
    ...
    },
    {
      ...
      subtitle: 'Komplexe Texte verstehen',
    ...
    },
    {
      id: 'C1',
      title: 'Kompetent',
      subtitle: 'Anspruchsvolle Texte verstehen',
      color: '#E91E63',
      icon: 'diamond',
    ...
    },
    {
      id: 'C2',
      title: 'Meister',
      subtitle: 'Muttersprachliches Leseverstehen',
      color: '#9C27B0',
      icon: 'crown',
  ...
  const goToNextQuestion = () => {
    if (currentQuestionIndex < selectedExercise.data.questions.length - 1) {
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
        <ExerciseView
          ...
          currentTextIndex={0} // Toujours 0 car un seul texte par exercice
          selectedAnswers={selectedAnswers}
          levelInfo={levels.find(l => l.id === selectedLevel)}
          onBack={() => setSelectedExercise(null)}
          onNextText={() => {}} // Pas de navigation entre textes
          onPreviousText={() => {}} // Pas de navigation entre textes
